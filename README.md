...
Этот проект демонстрирует различные подходы к интеграции Drools 10.0.0 с Spring Boot 3.5.0 и Java 17. Рассматриваются статическая и динамическая загрузка правил, использование KieHelper, и лучшие практики. В папке postman есть json для импорта в Postman. Так же в проекте подключен Swagger.
