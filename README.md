...
Этот проект демонстрирует различные подходы к интеграции Drools 10.0.0 с Spring Boot 3.2 и Java 17. Рассматриваются статическая и динамическая загрузка правил, использование KieHelper, и лучшие практики.
